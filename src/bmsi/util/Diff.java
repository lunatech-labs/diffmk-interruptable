...
public class Diff {
  ...
  private void compareseq (int xoff, int xlim, int yoff, int ylim) throws InterruptedException {
  ...
  /* Report the differences of two files.  DEPTH is the current directory
     depth. */
  public change diff_2(final boolean reverse) throws InterruptedException {
